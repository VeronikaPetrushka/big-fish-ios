const quiz = [
    {
      ...
      },
      {
        ...
        options: [
          { option: "A) Actinopterygii", correct: true },
          { option: "B) Chondrichthyes", correct: false },
          { option: "C) Sarcopterygii", correct: false },
          { option: "D) Agnatha", correct: false },
        ],
        allOptions: [
